...
from library_system import (
    Base, engine, init_db, add_author, add_book, 
    add_member, checkout_book, return_book
)

def seed():
    # Drop existing tables to allow re-seeding without IntegrityErrors
    ...
    orwell = add_author("George Orwell")

    add_book("The Hobbit", "978-0618260300", tolkien.id, 1937, ["Fantasy", "Adventure"])
    add_book("1984", "978-0451524935", orwell.id, 1949, ["Dystopian", "Fiction"])
